...
public interface BoardRepository extends JpaRepository<Board, Long>, SearchBoardRepository {
    ...
    //게시글 상세보기를 위한 메서드
    @Query("select b, w.memberNICKNAME, count(r) from Board b left join b.memberNICKNAME w left outer join Reply r on r.board = b where b.boardNUMBER = :boardNUMBER")
